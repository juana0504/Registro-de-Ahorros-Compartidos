    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <p class="text-center text-sm text-gray-600 mt-6">
                ¿No tienes cuenta? 
                <button onclick="switchToRegister()" class="text-blue-600 font-medium hover:underline">
                    Regístrate aquí
                </button>
            </p>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" id="registerName" class="input-field" placeholder="Tu nombre">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                    <input type="email" id="registerEmail" class="input-field" placeholder="tu@email.com">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Contraseña</label>
                    <input type="password" id="registerPassword" class="input-field" placeholder="••••••••">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Confirmar Contraseña</label>
                    <input type="password" id="registerConfirmPassword" class="input-field" placeholder="••••••••">
                </div>

                <button onclick="handleRegister()" class="btn-primary">
                    Crear Cuenta
                </button>
            </div>
