<form action="<?= BASE_URL ?>/guardar-usuario" method="POST" enctype="multipart/form-data">
    <div id="registerModal" class="modal">
        <div class="modal-content">
            ...
            <button type="button" onclick="closeRegisterModal()" class="close-btn">
            ...
            <div class="text-center mb-8">
                <svg class="w-12 h-12 text-green-600 mx-auto mb-4" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="password" name="confirmar_contrasena" id="registerConfirmPassword"
